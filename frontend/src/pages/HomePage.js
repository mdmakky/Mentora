                      ...
                      <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/30 shadow-xl card-hover h-full flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col">
                          ...
                          <div className="mb-4 min-h-[2.5rem] flex items-center">
                            {doc.is_embedded ? (
                              <span className="inline-flex items-center bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/50 dark:to-emerald-900/50 text-green-800 dark:text-green-200 text-xs font-medium px-3 py-1 rounded-full border border-green-200 dark:border-green-700 backdrop-blur-sm">
                              ...
                              <span className="inline-flex items-center bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/50 dark:to-amber-900/50 text-yellow-800 dark:text-yellow-200 text-xs font-medium px-3 py-1 rounded-full border border-yellow-200 dark:border-yellow-700 backdrop-blur-sm">
